...
export function ComingSoonPanel({ label }: { label: string }) {
  return (
    <div className="rounded-2xl border border-dashed border-[#d8c9a8] bg-info px-5 py-7 text-center min-[900px]:px-8 min-[900px]:py-12">
      <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-accent">Arriving soon</p>
      <h3 className="mt-2 font-serif text-[25px] font-semibold italic text-heading min-[900px]:text-4xl">
        {label} is being curated
      </h3>
      <p className="mx-auto mt-2.5 max-w-[38ch] text-sm leading-relaxed text-muted">
